...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-84-erd-s-problem-84-baf39534-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-84"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-84-erd-s-problem-84-baf39534-v1",
      "problem_contract_sha256": "5bb94d43fb0bbeb9f0e18b1a743c9cef3672b9a5706724fa057b3f69ecf24060",
      "problem_id": "problem:um-ep-84-erd-s-problem-84-baf39534",
      "route_id": "route:um-ep-84-erd-s-problem-84-baf39534-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-84-erd-s-problem-84-baf39534-source-fidelity-01",
      "graph_id": "graph:um-ep-84-erd-s-problem-84-baf39534-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-84-erd-s-problem-84-baf39534-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-84-erd-s-problem-84-baf39534-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "The cycle set of a graph $G$ on $n$ vertices is a set $A\\subseteq \\{3,\\ldots,n\\}$ such that there is a cycle in $G$ of length $\\ell$ if and only if $\\ell \\in A$. Let $f(n)$ count the number of possible such $A$. Prove that $f(n)=o(2^n)$. Prove that $f(n)/2^{n/2}\\to \\infty$."
          },
          "statement_sha256": "49b9445f21c7a06664b88066eb13c2734da70e2f0bfd0cc10f240aa2449a19d1"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-84-erd-s-problem-84-baf39534-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-84-erd-s-problem-84-baf39534-root",
      "route_id": "route:um-ep-84-erd-s-problem-84-baf39534-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-84-4eb3bd352c07",
        "url": "https://www.unsolvedmath.com/problems/EP-84"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
